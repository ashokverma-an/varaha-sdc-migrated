        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mb-1">Today</p>
              <p className="text-2xl font-bold text-green-600">{stats.todayReceived}</p>
            </div>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mb-1">Today</p>
              <p className="text-2xl font-bold text-orange-600">{stats.todayDue}</p>
            </div>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mb-1">Today</p>
              <p className="text-2xl font-bold text-red-600">{stats.todayWithdraw}</p>
            </div>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mb-1">Today</p>
              <p className="text-2xl font-bold text-purple-600">{stats.cashInHand}</p>
            </div>
