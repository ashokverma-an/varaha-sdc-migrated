...
export default function Header({ user }: HeaderProps) {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-xl shadow-lg border-b border-white/20 relative z-50 isolate">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-80 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                <div className={`p-2 bg-gradient-to-r ${getRoleColor(user.admin_type)} rounded-lg`}>
